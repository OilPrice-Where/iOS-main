...
//    
//    // HeaderView
//    lazy var mainListView = MainListView().then {
//        $0.tableView.dataSource = self
//        $0.tableView.delegate = self
//        // 가격순 버튼 설정
//        $0.priceSortedButton.addTarget(self, action: #selector(isTableViewSort(_:)), for: .touchUpInside)
//        // 거리순 버튼 설정
//        $0.distanceSortedButton.addTarget(self, action: #selector(isTableViewSort(_:)), for: .touchUpInside)
//        lastSelectedSortButton = $0.priceSortedButton
//    }
...
//            self.mainListView.tableView.reloadData()
//        }
//        
//        // researchButton 설정
...
//            mainListView.tableView.refreshControl = refreshControl
//        }
//        
//        // 현재 위치 버튼 기종별 설정
...
//            .map { !$0.isEmpty }
//            .bind(to: mainListView.noneView.rx.isHidden)
//            .disposed(by: rx.disposeBag)
//    }
//    
//    //Mark: Display 관련 설정
...
//                    let cell = mainListView.tableView.cellForRow(at: indexPath) as! GasStationCell
...
//                    let cell = mainListView.tableView.cellForRow(at: oldIndexPath) as! GasStationCell
//                    if cell.stationView.id == detailView.id {
//                        if detailView.favoriteButton.isSelected != cell.stationView.favoriteButton.isSelected {
//                            detailView.clickedEvent(detailView.favoriteButton)
//                        }
