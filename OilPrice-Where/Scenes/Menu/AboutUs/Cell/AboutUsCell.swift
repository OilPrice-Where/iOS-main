...
extension AboutUsCell {
    static let cellRegistration = UICollectionView.CellRegistration<AboutUsCell, SettingAboutUsViewModel.AboutMe> { cell, indexPath, aboutMe in
        cell.configure(
            name: aboutMe.name,
...
final class AboutUsCell: UICollectionViewCell {
...
private extension AboutUsCell {
    enum UIConstants {
        ...
        // Size
        static let contentViewHeight: CGFloat = 112.0
