...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let ink = ColorAsset(name: "Ink")
    internal static let ink2 = ColorAsset(name: "Ink2")
    ...
    internal static let surfaceSunken = ColorAsset(name: "SurfaceSunken")
